...
<head>
    ...
    <style>
        * {
        ...
        /* Schedule Alert Boxes */
        .schedule-alert {
            margin-bottom: 1.5rem;
            padding: 1.2rem;
            border-radius: var(--border-radius-sm);
            border-left: 4px solid var(--success);
            background: rgba(16, 185, 129, 0.15); /* Darker background */
        }

        .schedule-alert.primary {
            border-left-color: var(--primary);
            background: rgba(99, 102, 241, 0.15); /* Darker background */
        }
        ...
        .schedule-alert.primary .schedule-alert-time {
            color: var(--primary-light);
        }
...
<body>
    ...
    <header class="header">
        <div class="nav-container">
            ...
            <div class="nav-menu">
                ...
                <a href="#" class="nav-item">Nilai</a>
            </div>

            <div class="nav-user">
                <div class="user-info">
                    <div class="user-name">Budi Santoso, M.Pd.</div>
                    <div class="user-role">Mentor - IELTS Specialist</div>
                </div>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            <div class="header-content">
                ...
                <p class="dashboard-subtitle">Bimbing peserta menuju kesuksesan belajar bahasa Inggris</p>
            </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card accent" style="animation-delay: 0.3s">
                ...
                <div class="stat-label">Tugas Perlu Dinilai</div>
            </div>
        ...
        <div class="content-grid">
            <div class="main-content">
                    ...
                    <div class="card-body">
                        <div class="course-card">
                            ...
                            <div class="course-details">
                                ...
                                <div class="course-progress">8 Peserta • Sesi berikutnya: Hari ini 19:00</div>
                        ...
                        <div class="course-card">
                            ...
                            <div class="course-details">
                                ...
                                <div class="course-progress">6 Peserta • Sesi berikutnya: Besok 20:00</div>
                                <div class="progress-bar">
                        ...
                        <div class="course-card">
                            ...
                            <div class="course-details">
                                ...
                                <div class="course-progress">10 Peserta • Sesi berikutnya: Jumat 18:00</div>
                                <div class="progress-bar">
                ...
                <div class="card" style="animation-delay: 0.4s">
                    <div class="card-header">
                        <div class="card-title">Jawaban Tugas Perlu Dinilai</div>
                        <a href="#" class="card-link">
                            Lihat Semua <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>10 Jun 2024</td>
                                    <td><span class="status-badge status-warning">Perlu Dinilai</span></td>
                                </tr>
                                <tr>
                                    <td>Sari Dewi</td>
                                    <td>Business English</td>
                                    <td>Presentation Script</td>
                                    <td>09 Jun 2024</td>
                                    <td><span class="status-badge status-warning">Perlu Dinilai</span></td>
                                </tr>
                                <tr>
                ...
                <div class="card" style="animation-delay: 0.5s">
                    ...
                    <div class="card-body">
                        <div class="schedule-alert">
                            <div class="schedule-alert-title">IELTS Speaking</div>
                            <div class="schedule-alert-desc">8 peserta • Room A</div>
                            <div class="schedule-alert-time">19:00 - 20:30</div>
                        </div>
                        <div class="schedule-alert primary">
                            <div class="schedule-alert-title">Business English</div>
                            <div class="schedule-alert-desc">6 peserta • Room B</div>
                            <div class="schedule-alert-time">20:30 - 22:00</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Add click events for mentor dashboard
            const buttons = document.querySelectorAll('.btn-primary, .btn-outline');
            buttons.forEach(button => {
                button.addEventListener('click', function() {
                    const buttonText = this.textContent.trim();
                    alert(`Mentor Action: ${buttonText}\n\nFitur mentor akan diimplementasikan di backend.`);
                });
            });
            ...
            courseCards.forEach(card => {
                card.addEventListener('click', function() {
                    ...
                    alert(`Mentor: Detail kelas ${title}\n\nAkan menampilkan detail peserta dan progress.`);
                });
            });
            ...
            tableRows.forEach(row => {
                row.addEventListener('click', function() {
                    if(this.cells[0]) {
                        ...
                        const task = this.cells[2].textContent;
                        alert(`Mentor: Nilai tugas untuk ${student}\nTugas: ${task}\n\nAkan menampilkan form penilaian.`);
                    }
                });
            });
